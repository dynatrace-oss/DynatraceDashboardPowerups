...
class PayloadBuilder {
    ...
    isCaptureErrorsDisabled() {
        return this.commState.captureErrors === api_1.CaptureMode.Off || this.isCaptureDisabled();
    }
    isCaptureCrashesDisabled() {
        return this.commState.captureCrashes === api_1.CaptureMode.Off || this.isCaptureDisabled();
    }
}
