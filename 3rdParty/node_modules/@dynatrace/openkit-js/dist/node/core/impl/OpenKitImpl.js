...
const createIdProvider = (dcl) => dcl === 2 /* UserBehavior */ ? new SequenceIdProvider_1.SequenceIdProvider() : new SingleIdProvider_1.SingleIdProvider(1);
/**
...
class OpenKitImpl {
    ...
    constructor(config) {
        ...
        this.sessionConfig = Object.assign({}, config.privacy, config.openKit);
